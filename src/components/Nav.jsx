...
import mangaData from './mangaData'; // Import the manga data
import '../index.css';
...
const Nav = () => {
    ...
    const [filteredResults, setFilteredResults] = useState(mangaData);
    ...
    const handleSearch = (e) => {
        ...
        const results = mangaData.filter(item =>
    ...
    return (
        <>
                    <header className="text-black flex w-full items-center justify-between text-center mx-auto bg-gray-200">
                        ...
                        {/* Mobile Navigation */}
                        {nav && (
                            <div className="text-white fixed z-1 w-sm h-full right-0 top-0 border-r border-r-gray-900 bg-gray-700 ease-in-out duration-600 lg:hidden ">
                                <nav>
                        ...
                        <div className="flex  justify-center mx-auto w-auto items-center text-center">
                            {filteredResults.map(item => (
                                    <div className="flex mx-auto  flex-wrap drop-shadow-2xl m-4 justify-center ease-in-out duration-300">                                
                                        <Card image={item.image} title={item.title} stars={item.stars} />
                                    </div>
                            ))}
                        </div>
                    ) : (
                    ...
                    {/* Popular Section */}
                    <div>
                        <h2 className="flex items-center font-bold text-2xl p-4">Naruto Series - <FaFire  className="mx-2" size={20} color="black" /></h2>
                    </div>
